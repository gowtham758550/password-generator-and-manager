	...
	while(True):
		while(True):
			...
			if len(password1) > 7:
				...
				print("\n\nWarning!!!!!!!!!!!!!!")
				anime("Master password requires minimum 8 characters")
				time.sleep(2)
		...
		if password1 == password2:
			...
			print("\n\nWarning!!!!!!!!!!!!!!!")
			anime("Passwords are not matching (ᗒᗣᗕ)՞")
			time.sleep(2)
			x = input("\n\nPress enter to create again")
